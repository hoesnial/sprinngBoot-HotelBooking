package com.hotelbooking.hotelbookingapp.config;

import com.hotelbooking.hotelbookingapp.security.CustomAuthenticationSuccessHandler;
...
public class SecurityConfig {
    ...
    @Autowired // Opsional di Spring versi baru jika hanya ada satu constructor
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((authorize) ->
                        authorize.requestMatchers("/css/**", "/js/**", "/webjars/**", "/img/**").permitAll()
                                .requestMatchers("/", "/index", "/register/**", "/search/**", "/search-results/**", "/hotel-details/**").permitAll() // Ditambahkan path search agar bisa diakses publik
